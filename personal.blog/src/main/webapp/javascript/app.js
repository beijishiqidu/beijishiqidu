...
var App = (function() {
    ...
    var InitProvinceList = function() {
        $.post(urlPath + '/provinceList.do', {}, function(data) {
            for (var i = 0; i < data.length; i++) {
                $("#province").append($("<option></option>").val(data[i].id).html(data[i].name));
    ...
    var submitCustomerInfo = function() {
        ...
        $.post(urlPath + '/submitCustomerInfo.do', params, function(data) {
            if (data.result == false) {
                if (data.dbSave == true) {
                    ...
                    for (var i = 0; i < data.msg.length; i++) {
                        $('form div[class="field ' + data.msg[i].name + '"]').css('padding-bottom', '20px');
                        $('form input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                        $('form span[aria-owns="' + data.msg[i].name + '-menu"]').css('border', '1px solid red');

                        if ('province' == data.msg[i].name || 'city' == data.msg[i].name) {
                            if ('' != $('span[data-name=province-city]').html()) {
                                $('span[data-name=province-city]').html($('span[data-name=province-city]').html() + "， " + data.msg[i].value);
                            } else {
                                $('span[data-name=province-city]').html(data.msg[i].value);
                            }
                        } else {
                            $('span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                        }
                    }
                }
            } else {
                $.colorbox({
                    href: urlPath + '/reqDetailCustomerInfoPage.html?customerInfoId=' + data.customerInfoId,
                    innerWidth: 600,
                    overlayClose: false,
                    onComplete: function() {
    ...
    var submitCustomerDetailInfo = function() {
        ...
        $.post(urlPath + '/submitCustomerDetailInfo.do', params, function(data) {
            if (data.result == false) {
                if (data.dbSave == true) {
                    $('#popupResultMsg').html('<div class="error">' + data.msg + '</div>');
                    $.colorbox.resize();
                } else {
                    data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                    for (var i = 0; i < data.msg.length; i++) {
                        $('form div[class="field ' + data.msg[i].name + '"]').css('padding-bottom', '0px');
                        $('form input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                        $('form span[aria-owns="' + data.msg[i].name + '-menu"]').css('border', '1px solid red');
                        $('span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                    }
    ...
    var submitDesignerInfoCallback = function(data) {
        ...
        if (data.result == false) {
            if ((data.dbSave == true) || (data.repeat == true)) {
                ...
                data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                for (var i = 0; i < data.msg.length; i++) {
                    //$('#designerInfoForm div[class="field ' + data.msg[i].name + '"]').css('padding-bottom', '27px');
                    $('#designerInfoForm input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                    $('#designerInfoForm span[aria-owns="' + data.msg[i].name + '-menu"]').css('border', '1px solid red');

                    if ('province' == data.msg[i].name || 'city' == data.msg[i].name) {
                        if ('' != $('#designerInfoForm span[data-name=province-city]').html()) {
                            $('#designerInfoForm span[data-name=province-city]').html(
                                            $('span[data-name=province-city]').html() + "， " + data.msg[i].value);
                        } else {
                            $('#designerInfoForm span[data-name=province-city]').html(data.msg[i].value);
                        }
                    } else {
                        $('#designerInfoForm span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                    }
                }
            }
        } else {
    ...
    var submitDesignCaseCallback = function(data) {
        ...
        if (data.result == false) {
            if (data.dbSave == true) {
                ...
                data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                for (var i = 0; i < data.msg.length; i++) {
                    $('#designCaseAddForm div[class="field-container ' + data.msg[i].name + '"]').css('padding-bottom', '27px');
                    $('#designCaseAddForm input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                    $('#designCaseAddForm span[aria-owns="' + data.msg[i].name + '-menu"]').css('border', '1px solid red');
                    $('#designCaseAddForm span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                }
            }
        } else {
            $('#resultMsg').html('<div class="success">' + data.msg + '</div>');
            $('#designCaseId').val(data.caseId);
            setTimeout("top.location.href='" + App.getUrlPath() + "/admin/designCaseList.html" + "'", 1000); 
        }
    };
    ...
    var submitFrockCaseCallback = function(data) {
        ...
        if (data.result == false) {
            if (data.dbSave == true) {
                ...
                data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                for (var i = 0; i < data.msg.length; i++) {
                    $('#frockCaseAddForm div[class="field-container ' + data.msg[i].name + '"]').css('padding-bottom', '27px');
                    $('#frockCaseAddForm input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                    $('#frockCaseAddForm span[aria-owns="' + data.msg[i].name + '-menu"]').css('border', '1px solid red');
                    $('#frockCaseAddForm span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                }
            }
        } else {
            $('#resultMsg').html('<div class="success">' + data.msg + '</div>');
            $('#frockCaseId').val(data.caseId);
            setTimeout("top.location.href='" + App.getUrlPath() + "/admin/frockCaseList.html" + "'", 1000); 
        }
    };
    ...
    var submitBackendAddDesignerCallback = function(data) {
        ...
        if (data.result == false) {
            if (data.dbSave == true) {
                ...
                data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                for (var i = 0; i < data.msg.length; i++) {
                    $('#designerAddForm input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                    $('#designerAddForm span[aria-owns="' + data.msg[i].name + '-menu"]').css('border', '1px solid red');
                    $('#designerAddForm span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                }
            }
        } else {
            $('#resultMsg').html('<div class="success">' + data.msg + '</div>');
            ...
            //自动跳转到列表页面
            setTimeout("top.location.href='" + App.getUrlPath() + "/admin/designerList.html" + "'", 1000); 
        }
    };
    ...
    var submitCustomerJoinInfo = function() {
        ...
        $.post(urlPath + '/customerJoin.do', params, function(data) {
            $('#token').val(data.token);
            if (data.result == false) {
                if ((data.dbSave == true) || (data.repeat == true)) {
                    $('#resultMsg').html('<div class="error">' + data.msg + '</div>');
                    ...
                    data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                    for (var i = 0; i < data.msg.length; i++) {
                        $('#customerJoinForm div[class="field ' + data.msg[i].name + '"]').css('padding-bottom', '27px');
                        $('#customerJoinForm input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                        $('#customerJoinForm span[aria-owns="' + data.msg[i].name + '-menu"]').css('border', '1px solid red');

                        if ('province' == data.msg[i].name || 'city' == data.msg[i].name) {
                            if ('' != $('span[data-name=province-city]').html()) {
                                $('#customerJoinForm span[data-name=province-city]').html(
                                                $('span[data-name=province-city]').html() + "， " + data.msg[i].value);
                            } else {
                                $('#customerJoinForm span[data-name=province-city]').html(data.msg[i].value);
                            }
                        } else {
                            $('#customerJoinForm span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                        }
                    }
                }
            } else {
    ...
    var submitCustomerSummaryInfo = function() {
        ...
        $.post(urlPath + '/submitCustomerSummaryInfo.do', params, function(data) {
            if (data.result == false) {
                if (data.dbSave == true) {
                    $('#summaryResultMsg').html('<div class="error">' + data.msg + '</div>');
                    $.colorbox.resize();
                } else {
                    data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                    for (var i = 0; i < data.msg.length; i++) {
                        //$('.bottom-register-form form div[class="field ' + data.msg[i].name + '"]').css('padding-bottom', '27px');
                        $('.bottom-register-form form input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                        $('.bottom-register-form form span[aria-owns="' + data.msg[i].name + '-menu"]').css('border', '1px solid red');
                        $('.bottom-register-form span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                    }
                }
            } else {
                $('#summaryResultMsg').html('<div class="success">' + data.msg + '</div>');
            }
    ...
    var submitNewsInfo = function() {
        // 清除错误提示信息
        clearErrorMsg();
        $('#newsAddForm .edui-default.edui-editor').css('border', '1px solid #d4d4d4');
        $('#newsAddForm').submit();
    };

    var submitNewsInfoCallback = function(data) {
        var data = jQuery.parseJSON(data);
        ...
        if (data.result == false) {
            if (data.dbSave == true) {
                ...
                data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                for (var i = 0; i < data.msg.length; i++) {
                    $('#newsAddForm input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                    if ('content' == data.msg[i].name) {
                        $('#newsAddForm .edui-default.edui-editor').css('border', '1px solid red');
                    }

                    $('#newsAddForm span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                }
            }
        } else {
            $('#resultMsg').html('<div class="success">' + data.msg + '</div>');
    ...
    var submitDecorateDiaryInfo = function() {
        // 清除错误提示信息
        clearErrorMsg();
        $('#decorateDiaryAddForm .edui-default.edui-editor').css('border', '1px solid #d4d4d4');
    ...
    var submitDecorateDiaryInfoCallback = function(data) {
        ...
        if (data.result == false) {
            if (data.dbSave == true) {
                ...
                data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                for (var i = 0; i < data.msg.length; i++) {
                    $('#decorateDiaryAddForm input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                    if ('content' == data.msg[i].name) {
                        $('#decorateDiaryAddForm .edui-default.edui-editor').css('border', '1px solid red');
                    }

                    $('#decorateDiaryAddForm span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                }
            }
        } else {
            $('#resultMsg').html('<div class="success">' + data.msg + '</div>');
            setTimeout("top.location.href='" + App.getUrlPath() + "/admin/decorateDiaryList.html" + "'", 1000); 
        }
    ...
    var submitDecorateKnowledgeInfo = function() {
        // 清除错误提示信息
        clearErrorMsg();
        $('#decorateKnowledgeAddForm .edui-default.edui-editor').css('border', '1px solid #d4d4d4');
    ...
    var submitDecorateKnowledgeInfoCallback = function(data) {
        ...
        if (data.result == false) {
            if (data.dbSave == true) {
                ...
                data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                for (var i = 0; i < data.msg.length; i++) {
                    $('#decorateKnowledgeAddForm input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                    if ('content' == data.msg[i].name) {
                        $('#decorateDiaryAddForm .edui-default.edui-editor').css('border', '1px solid red');
                    }

                    $('#decorateKnowledgeAddForm span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                }
            }
        } else {
            $('#resultMsg').html('<div class="success">' + data.msg + '</div>');
            setTimeout("top.location.href='" + App.getUrlPath() + "/admin/decorateKnowledgeList.html" + "'", 1000);
        }
    ...
    var deleteNewsById = function(newsId, firstResult, maxResults) {
        $.post(urlPath + '/deleteNews.do', {
            newsId: newsId,
    ...
    var deleteDecorateDiaryById = function(decorateDiaryId, firstResult, maxResults) {
    ...
    var deleteDesignerJoinById = function(designerJoinId, firstResult, maxResults) {
    ...
    var deleteCustomerJoinById = function(customerJoinId, firstResult, maxResults) {
    ...
    var deleteCustomerInfoById = function(customerInfoId, firstResult, maxResults) {
    ...
    var deleteDecorateKnowledgeById = function(decorateKnowledgeId, firstResult, maxResults) {
        ...
        $.post(urlPath + url, params, function(data) {
            if (data.result == false) {
                if (data.dbSave == true) {
                    ...
                    data.msg = Common.sortJsonDataByKey(data.msg, 'value');
                    for (var i = 0; i < data.msg.length; i++) {
                        $form.find('input[name="' + data.msg[i].name + '"]').css('border', '1px solid red');
                        if ('content' == data.msg[i].name) {
                            $form.find('.edui-default.edui-editor').css('border', '1px solid red');
                        }

                        $form.find('span[data-name=' + data.msg[i].name + ']').html(data.msg[i].value);
                    }
                }
            } else {
                $('#resultMsg').html('<div class="success">' + data.msg + '</div>');
    ...
    var initFilterAreaSelected = function() {
        ...
        $('.style.style-list').find('span[data-id="' + caseStyleId + '"]').each(function() {
            $(this).css('color', '#dc1515').css('font-weight', 'bold');
        });
        $('.home.style-list').find('span[data-id="' + homeTypeId + '"]').each(function() {
            $(this).css('color', '#dc1515').css('font-weight', 'bold');
        });
        $('.area.style-list').find('span[data-id="' + sizeTypeId + '"]').each(function() {
            $(this).css('color', '#dc1515').css('font-weight', 'bold');
        });
    };
    ...
    var execFilterDesignCaseList = function() {
        ...
        $.post(urlPath + '/ajaxRefreshDesignCaseList.html', params, function(data) {
            $('#main-content-wrapper').html(data);
        });
    };
    ...
    return {
        ...
        submitNewsInfo: submitNewsInfo,
        submitNewsInfoCallback: submitNewsInfoCallback,
