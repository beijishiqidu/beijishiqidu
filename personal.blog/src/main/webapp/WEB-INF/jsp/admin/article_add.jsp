		...
		<div class="home-wrapper">
			<div class="main-menu">
				...
				<div class="main-content">
                    ...
                    enctype="multipart/form-data" target="hideframe" action="<c:url value="/saveNewsInfo.do"/>">
						    <input name="articleId" id="articleId" value="${articleObj.id}" type="hidden"/>
						    <div class="title-container">
    						    <label>文章标题:</label><input name="title" class="title" type="text" value="${articleObj.title}"/>
    						    <span data-name="title" class="error-tips"></span>
						    </div>
							<!-- 加载编辑器的容器 -->
							<label>详细内容:</label>
                            ...
                            <div class="button-area">
                                <button type="button" onclick="App.submitNewsInfo();">保存</button>
